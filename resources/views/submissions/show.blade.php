        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                @if ($submission->product_photo_url)
                    <div>
                        ...
                        <img src="{{ Storage::url($submission->product_photo_url) }}" class="w-48 rounded border">
                    </div>
                @endif
            </div>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                @if ($submission->survey_photo_url)
                    <img src="{{ Storage::url($submission->survey_photo_url) }}" class="w-48 rounded border mb-2">
